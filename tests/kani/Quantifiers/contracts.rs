...
#[cfg_attr(kani, kani::proof_for_contract(set_zero))]
fn set_zero_harness() {
...
#[cfg_attr(kani, kani::modifies(ys))]
...
#[cfg_attr(kani, kani::proof_for_contract(copy))]
fn copy_harness() {
